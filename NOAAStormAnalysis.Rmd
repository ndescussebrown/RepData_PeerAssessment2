# Identification of NOAA US storm events most harmful with respect to population health and those with greatest economic consequences between 1996 and 2011
...
As can be seen, 70% of the overall number of fatalities and injuries are attributable to 4 event types only, namely `r dfplot[which(dfplot$variable=="sum",arr.ind=TRUE),1]` .
...
We can see that 70% of the overall number of fatalities and injuries are attributable to 4 event types only, namely `r dfplot2[which(dfplot2$variable=="sum",arr.ind=TRUE),1]`. So we can conclude that the actual ranking of the weather events most harmful to the population has not changed in the sensitivity analysis.
...
We can see that 70% of the overall cost of property damage and crop damage are attributable to 4 event types only, namely `r dfeconplot2[which(dfeconplot2$variable=="sum",arr.ind=TRUE),1]`. So we can conclude that the actual ranking of the weather events most harmful to the population has not changed in the sensitivity analysis.